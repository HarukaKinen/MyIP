...
const countryData: CountryData[] = [
	...
	{ acronym: "CD", name: "Congo, The Democratic Republic of the" },
	...
	{ acronym: "FM", name: "Micronesia, Federated States of" },
	...
	{ acronym: "IR", name: "Iran, Islamic Republic of" },
	...
	{ acronym: "KP", name: 'Korea, Democratic People"s Republic of' },
	...
	{ acronym: "PS", name: "Palestine, State of" },
	...
	{ acronym: "TZ", name: "Tanzania, United Republic of" },
...
export function getCountryName(code: string): string | null {
	const country = countryData.find((country) => country.acronym === code);
